...
procedure TAppViewModelTestCase.Test_IncrementCountBy2_MaximumCount();
begin
  ExpectedException := EInvalidOperation;
  AppViewModel.Count := MaximumCount;
  AppViewModel.IncrementCountBy2();
end;

procedure TAppViewModelTestCase.Test_IncrementCountBy2_MaximumCount_Minus1();
begin
  ExpectedException := EInvalidOperation;
  AppViewModel.Count := MaximumCount-1;
  AppViewModel.IncrementCountBy2();
...
procedure TAppViewModelTestCase.Test_IncrementCountBy2_MaximumCount_Plus1();
begin
  ExpectedException := EArgumentOutOfRangeException;
  AppViewModel.Count := MaximumCount+1;
  AppViewModel.IncrementCountBy2();
...
procedure TAppViewModelTestCase.Test_IncrementCountBy2_MinimumCount();
begin
  AppViewModel.Count := MinimumCount;
  AppViewModel.IncrementCountBy2();
end;

procedure TAppViewModelTestCase.Test_IncrementCountBy2_MinimumCount_Minus1();
begin
  ExpectedException := EArgumentOutOfRangeException;
  AppViewModel.Count := MinimumCount-1;
  AppViewModel.IncrementCountBy2();
...
procedure TAppViewModelTestCase.Test_IncrementCountBy2_MinimumCount_Plus1();
begin
  AppViewModel.Count := MinimumCount+1;
  AppViewModel.IncrementCountBy2();
end;

procedure TAppViewModelTestCase.Test_IncrementCountByIncrementValue_MinimumCount();
begin
  AppViewModel.Count := MinimumCount;
  AppViewModel.IncrementValue := 5;
  AppViewModel.IncrementCountByIncrementValue();
end;

procedure TAppViewModelTestCase.Test_IncrementCountByIncrementValue_MinimumCount_Plus1();
begin
  AppViewModel.Count := MinimumCount+1;
  AppViewModel.IncrementValue := 5;
  AppViewModel.IncrementCountByIncrementValue();
...
procedure TAppViewModelTestCase.Test_IncrementCountByIncrementValue_MinimumCount_Minus1();
begin
  ExpectedException := EArgumentOutOfRangeException;
  AppViewModel.Count := MinimumCount-1;
  AppViewModel.IncrementValue := 5;
...
procedure TAppViewModelTestCase.Test_IncrementCountByIncrementValue_MaximumCount();
begin
  ExpectedException := EInvalidOperation;
  AppViewModel.Count := MaximumCount;
  AppViewModel.IncrementValue := 5;
...
procedure TAppViewModelTestCase.Test_IncrementCountByIncrementValue_MaximumCount_Plus1();
begin
  ExpectedException := EArgumentOutOfRangeException;
  AppViewModel.Count := MaximumCount+1;
  AppViewModel.IncrementValue := 5;
...
procedure TAppViewModelTestCase.Test_IncrementCountByIncrementValue_MaximumCount_Minus1();
begin
  ExpectedException := EInvalidOperation;
  AppViewModel.Count := MaximumCount-1;
  AppViewModel.IncrementValue := 5;
...
procedure TAppViewModelTestCase.Test_MultiplyCountBy2_MaximumCount();
begin
  ExpectedException := EInvalidOperation;
  AppViewModel.Count := MaximumCount;
  AppViewModel.MultiplyCountBy2();
end;

procedure TAppViewModelTestCase.Test_MultiplyCountBy2_MaximumCount_Minus1();
begin
  ExpectedException := EInvalidOperation;
  AppViewModel.Count := MaximumCount-1;
  AppViewModel.MultiplyCountBy2();
...
procedure TAppViewModelTestCase.Test_MultiplyCountBy2_MaximumCount_Plus1();
begin
  ExpectedException := EArgumentOutOfRangeException;
  AppViewModel.Count := MaximumCount+1;
  AppViewModel.MultiplyCountBy2();
...
procedure TAppViewModelTestCase.Test_MultiplyCountBy2_MinimumCount();
begin
  ExpectedException := EInvalidOperation;
  AppViewModel.Count := MinimumCount;
  AppViewModel.MultiplyCountBy2();
...
procedure TAppViewModelTestCase.Test_MultiplyCountBy2_MinimumCount_Minus1();
begin
  ExpectedException := EArgumentOutOfRangeException;
  AppViewModel.Count := MinimumCount-1;
  AppViewModel.MultiplyCountBy2();
...
procedure TAppViewModelTestCase.Test_MultiplyCountBy2_MinimumCount_Plus1();
begin
  ExpectedException := EInvalidOperation;
  AppViewModel.Count := MinimumCount+1;
  AppViewModel.MultiplyCountBy2();
