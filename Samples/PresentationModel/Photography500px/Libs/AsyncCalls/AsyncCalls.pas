...
{$ENDIF DEBUG_ASYNCCALLS}
  uses Windows, Messages, SysUtils, Classes, Contnrs, ActiveX, SyncObjs;
...
type
  ...
  // function(Arg1: Type1; Arg2: Type2; ...) of object; cdecl;
  ...
  TAsyncCallArgWideStringMethod = function(const Arg: WideString)
    : Integer of object;
  TAsyncCallArgInterfaceMethod = function(const Arg: IInterface)
    : Integer of object;
  TAsyncCallArgExtendedMethod = function(const Arg: Extended)
    : Integer of object;
  ...
  TAsyncCallArgRecordMethod = function(var Arg { : TRecordType } )
    : Integer of object;
...
function AsyncCall(Proc: TAsyncCallArgObjectProc; Arg: TObject)
  : IAsyncCall; overload;
function AsyncCall(Proc: TAsyncCallArgIntegerProc; Arg: Integer)
  : IAsyncCall; overload;
...
function AsyncCall(Method: TAsyncCallArgObjectMethod; Arg: TObject)
  : IAsyncCall; overload;
...
function AsyncCall(Method: TAsyncCallArgStringMethod; const Arg: string)
  : IAsyncCall; overload;
function AsyncCall(Method: TAsyncCallArgWideStringMethod; const Arg: WideString)
  : IAsyncCall; overload;
...
function AsyncCall(Method: TAsyncCallArgObjectEvent; Arg: TObject)
  : IAsyncCall; overload;
function AsyncCall(Method: TAsyncCallArgIntegerEvent; Arg: Integer)
  : IAsyncCall; overload;
...
procedure AsyncExec(Method: TNotifyEvent; Arg: TObject;
  IdleMsgMethod: TAsyncIdleMsgMethod);
...
function LocalAsyncCallEx(LocalProc: TLocalAsyncProcEx; Param: INT_PTR)
  : IAsyncCall;
procedure LocalAsyncExec(Proc: TLocalAsyncProc;
  IdleMsgMethod: TAsyncIdleMsgMethod);
...
function AsyncCallEx(Proc: TAsyncCallArgRecordProc; var Arg { : TRecordType } )
  : IAsyncCall; overload;
function AsyncCallEx(Method: TAsyncCallArgRecordMethod;
  var Arg { : TRecordType } ): IAsyncCall; overload;
function AsyncCallEx(Method: TAsyncCallArgRecordEvent;
  var Arg { : TRecordType } ): IAsyncCall; overload;
...
function AsyncCall(Proc: TCdeclFunc; const Args: array of const)
  : IAsyncCall; overload;
function AsyncCall(Proc: TCdeclMethod; const Args: array of const)
  : IAsyncCall; overload;
{$ENDIF SUPPORT_LOCAL_FUNCTIONS}
...
function AsyncMultiSync(const List: array of IAsyncCall;
  WaitAll: Boolean = True; Milliseconds: Cardinal = INFINITE): Cardinal;
function AsyncMultiSyncEx(const List: array of IAsyncCall;
  const Handles: array of THandle; WaitAll: Boolean = True;
...
function MsgAsyncMultiSyncEx(const List: array of IAsyncCall;
  const Handles: array of THandle; WaitAll: Boolean; Milliseconds: Cardinal;
  dwWakeMask: DWORD): Cardinal;
...
type
  ...
  TMultiArgProcCall<TProc, T1, T2, T3, T4> = class
  ...
  private type
    ...
    TAsyncCallArgGenericProc<T1, T2, T3> = function(Arg1: T1; Arg2: T2;
      Arg3: T3): Integer;
    TAsyncCallArgGenericProc<T1, T2, T3, T4> = function(Arg1: T1; Arg2: T2;
      Arg3: T3; Arg4: T4): Integer;
    TAsyncCallArgGenericMethod<T> = function(Arg: T): Integer of object;
    TAsyncCallArgGenericMethod<T1, T2> = function(Arg1: T1; Arg2: T2)
      : Integer of object;
    TAsyncCallArgGenericMethod<T1, T2, T3> = function(Arg1: T1; Arg2: T2;
      Arg3: T3): Integer of object;
    TAsyncCallArgGenericMethod<T1, T2, T3, T4> = function(Arg1: T1; Arg2: T2;
      Arg3: T3; Arg4: T4): Integer of object;
    ...
    TAsyncCallArg<T1, T2> = class
      (TMultiArgProcCall<TAsyncCallArgGenericProc<T1, T2>, T1, T2>)
    protected
      function ExecuteAsyncCall: Integer; override;
    end;

    TAsyncCallArg<T1, T2, T3> = class
      (TMultiArgProcCall<TAsyncCallArgGenericProc<T1, T2, T3>, T1, T2, T3>)
    protected
      function ExecuteAsyncCall: Integer; override;
    end;

    TAsyncCallArg<T1, T2, T3, T4> = class
      (TMultiArgProcCall<TAsyncCallArgGenericProc<T1, T2, T3, T4>, T1,
      T2, T3, T4>)
    protected
      function ExecuteAsyncCall: Integer; override;
    end;

    TAsyncCallArgMethod<T> = class
      (TMultiArgProcCall<TAsyncCallArgGenericMethod<T>, T>)
    protected
      function ExecuteAsyncCall: Integer; override;
    end;

    TAsyncCallArgMethod<T1, T2> = class
      (TMultiArgProcCall<TAsyncCallArgGenericMethod<T1, T2>, T1, T2>)
    protected
      function ExecuteAsyncCall: Integer; override;
    end;

    TAsyncCallArgMethod<T1, T2, T3> = class
      (TMultiArgProcCall<TAsyncCallArgGenericMethod<T1, T2, T3>, T1, T2, T3>)
    protected
      function ExecuteAsyncCall: Integer; override;
    end;

    TAsyncCallArgMethod<T1, T2, T3, T4> = class
      (TMultiArgProcCall<TAsyncCallArgGenericMethod<T1, T2, T3, T4>, T1,
      T2, T3, T4>)
    protected
      function ExecuteAsyncCall: Integer; override;
    end;
  ...
  public
    ...
    class function Invoke<T>(Proc: TAsyncCallArgGenericProc<T>; const Arg: T)
      : IAsyncCall; overload; static;
    class function Invoke<T>(Event: TAsyncCallArgGenericMethod<T>; const Arg: T)
      : IAsyncCall; overload; static;
    class function Invoke<T1, T2>(Proc: TAsyncCallArgGenericProc<T1, T2>;
      const Arg1: T1; const Arg2: T2): IAsyncCall; overload; static;
    class function Invoke<T1, T2>(Event: TAsyncCallArgGenericMethod<T1, T2>;
      const Arg1: T1; const Arg2: T2): IAsyncCall; overload; static;
    class function Invoke<T1, T2, T3>(Proc: TAsyncCallArgGenericProc<T1, T2,
      T3>; const Arg1: T1; const Arg2: T2; const Arg3: T3): IAsyncCall;
      overload; static;
    class function Invoke<T1, T2, T3>(Event: TAsyncCallArgGenericMethod<T1, T2,
      T3>; const Arg1: T1; const Arg2: T2; const Arg3: T3): IAsyncCall;
      overload; static;
    class function Invoke<T1, T2, T3, T4>
      (Proc: TAsyncCallArgGenericProc<T1, T2, T3, T4>; const Arg1: T1;
      const Arg2: T2; const Arg3: T3; const Arg4: T4): IAsyncCall;
      overload; static;
    class function Invoke<T1, T2, T3, T4>
      (Event: TAsyncCallArgGenericMethod<T1, T2, T3, T4>; const Arg1: T1;
      const Arg2: T2; const Arg3: T3; const Arg4: T4): IAsyncCall;
      overload; static;
    ...
    { MsgExec waits for the @AsyncCall to finish. If there are any messages in
      ...
      @IdleMsgMethod. }
    class procedure MsgExec(AsyncCall: IAsyncCall;
      IdleMsgMethod: TAsyncIdleMsgMethod); static;
...
resourcestring
  ...
  RsLeaveMainThreadNestedError =
    'Unpaired call to AsyncCalls.LeaveMainThread()';
  RsLeaveMainThreadThreadError =
...
class procedure TThread.StaticSynchronize(AThread: TThread;
...
type
  ...
  protected
    function ExecuteAsyncCall: Integer; override;
  public
    constructor Create(AProc: TAsyncCallArgWideStringProc;
  ...
  protected
    function ExecuteAsyncCall: Integer; override;
  public
    constructor Create(AProc: TAsyncCallArgInterfaceProc;
  ...
  protected
    function ExecuteAsyncCall: Integer; override;
  public
    constructor Create(AProc: TLocalAsyncProc; AParam: INT_PTR;
      ABasePointer: Pointer);
  end;
  ...
  protected
    function ExecuteAsyncCall: Integer; override;
  public
    constructor Create(AProc: TLocalVclProc; AParam: INT_PTR;
      ABasePointer: Pointer);
  end;
  {$ENDIF SUPPORT_LOCAL_FUNCTIONS}
  { ---------------------------------------------------------------------------- }
  ...
  protected
    function ExecuteAsyncCall: Integer; override;
  public
    constructor Create(AProc: TAsyncCallArgWideStringMethod;
      const AArg: WideString);
  end;
  ...
  protected
    function ExecuteAsyncCall: Integer; override;
  public
    constructor Create(AProc: TAsyncCallArgInterfaceMethod;
      const AArg: IInterface);
  end;
  ...
  protected
    function ExecuteAsyncCall: Integer; override;
  public
    constructor Create(AProc: TAsyncCallArgExtendedMethod;
      const AArg: Extended);
  end;
  ...
  public
    ...
    constructor Create(AProc: Pointer; MethodData: TObject;
...
begin
  Result := TAsyncCallLocalProcEx.Create(LocalProc, Param, BasePointer)
    .ExecuteAsync;
end;
...
procedure InternLocalAsyncExec(LocalProc: TLocalAsyncProc;
  IdleMsgMethod: TAsyncIdleMsgMethod; BasePointer: Pointer);
var
  Handle: IAsyncCall;
begin
...
function AsyncCallEx(Method: TAsyncCallArgRecordMethod;
  var Arg { : TRecordType } ): IAsyncCall;
begin
  { Execute the function synchron if no thread pool exists }
  if ThreadPool.MaxThreads = 0 then
    Result := TSyncCall.Create(Method(Arg))
  ...
  try
    ...
    begin
      repeat
        if MsgWait then
        begin
          Result := MsgWaitForMultipleObjects(Count + 2, Handles[0], WaitAll,
            Timeout, dwWakeMask);
          if Result = WAIT_OBJECT_0 + Count + 2 then
          begin
            ThreadPool.ProcessMainThreadSync; // also uses the message queue
            Result := WAIT_OBJECT_0 + OriginalCount;
            // caller doesn't know about the 2 synchronization events
            Exit;
          end;
        end
        else
          Result := WaitForMultipleObjects(Count + 2, @Handles[0],
            WaitAll, Timeout);
        ...
        if Result = WAIT_OBJECT_0 + Count then
          ...
          ThreadPool.ProcessMainThreadSync;
      until (Result <> WAIT_OBJECT_0 + Count) and
    ...
    begin
      ...
      repeat
        if MsgWait then
        begin
          Result := MsgWaitForMultipleObjects(Count + 2, Handles[0], False,
            Timeout, dwWakeMask);
          if Result = WAIT_OBJECT_0 + Count + 2 then
          begin
            ThreadPool.ProcessMainThreadSync; // also uses the message queue
        ...
        if Result = WAIT_OBJECT_0 + Count then
          ...
          ThreadPool.ProcessMainThreadSync
        else if { (Result >= WAIT_OBJECT_0) and } (Result <= WAIT_OBJECT_0 +
          Count) then
        begin
          ...
          begin
            ...
            Move(Handles[Index + 1], Handles[Index], ((Count + 2) - Index) *
              SizeOf(THandle));
          end;
        end
        else
...
function InternalAsyncMultiSync(const List: array of IAsyncCall;
  const Handles: array of THandle; WaitAll: Boolean; Milliseconds: Cardinal;
  MsgWait: Boolean; dwWakeMask: DWORD): Cardinal;

  function InternalWait(const List: array of IAsyncCall;
    const Handles: array of THandle; WaitAll: Boolean; Milliseconds: Cardinal;
    MsgWait: Boolean; dwWakeMask: DWORD): Cardinal;
  var
  ...
  begin
    ...
    begin
      ...
      else if (SignalState >= WAIT_ABANDONED_0) and
        (SignalState < WAIT_ABANDONED_0 + Count) then
  ...
  function InternalWaitAllInfinite(const List: array of IAsyncCall;
    const Handles: array of THandle): Cardinal;
  var
    I: Integer;
  begin
...
function AsyncMultiSyncEx(const List: array of IAsyncCall;
  ...
  Milliseconds: Cardinal = INFINITE): Cardinal;
begin
  Result := InternalAsyncMultiSync(List, Handles, WaitAll, Milliseconds,
    False, 0);
end;
...
begin
  ...
  Priority := tpHigher;
  // faster initial start of the thread. Is revoked after getting an IAsyncCall request
end;
...
begin
  ...
  try
    while True do
    begin
      FAsyncCall := ThreadPool.GetNextAsyncCall;
      // calls Sleep if nothing has to be done
      Priority := tpNormal;
      ...
      begin
        ...
        FAsyncCall := ThreadPool.GetNextAsyncCall;
        // Doesn't go to sleep due to signaled ThreadPool.FThreadTerminateEvent
        if FAsyncCall = nil then
          Break;
      end;
...
begin
  ...
  FDestroying := True;
  // => Sync in this thread because there is no other thread (required for FAsnycCallHead.Free)
...
begin
  ...
  if FAsyncCallHead <> nil then
  // unsafe access, but WakeUpThread would only wake up a thread that will immediately go to sleep
    WakeUpThread;
...
begin
  ...
  // spinning, but we may take too much time
  try
    Item := FAsyncCallHead;
    if Item = Call then
    begin
...
begin
  ...
  repeat
    Index := FThreadCount;
  until (Index = FMaxThreads) or
    (InterlockedCompareExchange(FThreadCount, Index + 1, Index) = Index);
...
begin
  if FCanceled or (FCancelInvocation and not FExecuted) then
    ...
    Result := (FEvent = 0) or FFinished or
      (WaitForSingleObject(FEvent, 0) = WAIT_OBJECT_0);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      else if WaitForSingleObject(FEvent, INFINITE) <> WAIT_OBJECT_0 then
        NotFinishedError('IAsyncCall.Sync');
    end;
  end;
  Result := FReturnValue;
...
constructor TAsyncCallArrayOfConst.Create(AProc: Pointer;
...
begin
  ...
  begin
    ...
    case V.VType of
      ...
      vtWideString:
        WideString(V.VWideString) := '';
      {$IFDEF UNICODE}
      vtUnicodeString:
        UnicodeString(V.VUnicodeString) := '';
      {$ENDIF UNICODE}
      vtInterface:
        IInterface(V.VInterface) := nil;
...
procedure TAsyncCallArrayOfConst.CopyVarRec(const Data: TVarRec;
  var Result: TVarRec);
begin
  if (Data.VPointer <> nil) and
    (Data.VType in [vtString, vtAnsiString, vtWideString,
    {$IFDEF UNICODE}vtUnicodeString,
    {$ENDIF} vtExtended, vtCurrency, vtInt64, vtVariant, vtInterface]) then
  begin
    ...
    case Result.VType of
      vtAnsiString:
        AnsiString(Result.VAnsiString) := AnsiString(Data.VAnsiString);
      vtWideString:
        WideString(Result.VWideString) := WideString(Data.VWideString);
      {$IFDEF UNICODE}
      vtUnicodeString:
      ...
      {$ENDIF UNICODE}
      vtInterface:
        IInterface(Result.VInterface) := IInterface(Data.VInterface);

      vtString:
        begin
          New(Result.VString);
          Result.VString^ := Data.VString^;
        end;
      vtExtended:
        begin
          New(Result.VExtended);
          Result.VExtended^ := Data.VExtended^;
        end;
      vtCurrency:
        begin
          New(Result.VCurrency);
          Result.VCurrency^ := Data.VCurrency^;
        end;
      vtInt64:
        begin
          New(Result.VInt64);
          Result.VInt64^ := Data.VInt64^;
        end;
      vtVariant:
        begin
          New(Result.VVariant);
          Result.VVariant^ := Data.VVariant^;
        end;
    end;
  end
  else
...
constructor TAsyncCallArgRecord.Create(AProc: TAsyncCallArgRecordProc;
  AArg: Pointer);
begin
  inherited Create;
  FProc := AProc;
...
constructor TAsyncCallArgObject.Create(AProc: TAsyncCallArgObjectProc;
  AArg: TObject);
begin
  inherited Create;
  FProc := AProc;
...
constructor TAsyncCallMethodArgWideString.Create
  (AProc: TAsyncCallArgWideStringMethod; const AArg: WideString);
begin
  inherited Create;
  FProc := AProc;
  FArg := AArg;
...
constructor TAsyncCallMethodArgInterface.Create
  (AProc: TAsyncCallArgInterfaceMethod; const AArg: IInterface);
begin
  inherited Create;
  FProc := AProc;
  FArg := AArg;
...
constructor TAsyncCallArgExtended.Create(AProc: TAsyncCallArgExtendedProc;
  const AArg: Extended);
begin
  inherited Create;
  FProc := AProc;
...
constructor TAsyncCallMethodArgExtended.Create
  (AProc: TAsyncCallArgExtendedMethod; const AArg: Extended);
begin
  inherited Create;
  FProc := AProc;
  FArg := AArg;
...
constructor TAsyncCallArgVariant.Create(AProc: TAsyncCallArgVariantProc;
  const AArg: Variant);
begin
  inherited Create;
  FProc := AProc;
...
constructor TAsyncCallLocalProc.Create(AProc: TLocalAsyncProc;
  ABasePointer: Pointer);
begin
  inherited Create;
  @FProc := @AProc;
...
constructor TAsyncCallLocalProcEx.Create(AProc: TLocalAsyncProc;
  AParam: INT_PTR; ABasePointer: Pointer);
begin
  inherited Create;
  @FProc := @AProc;
  FBasePointer := ABasePointer;
...
constructor TAsyncVclCallLocalProc.Create(AProc: TLocalVclProc; AParam: INT_PTR;
  ABasePointer: Pointer);
begin
  inherited Create;
  @FProc := @AProc;
...
procedure InternLocalVclCall(LocalProc: TLocalVclProc; Param: INT_PTR;
  BasePointer: Pointer);
var
  M: TMethod;
...
function InternLocalAsyncVclCall(LocalProc: TLocalVclProc; Param: INT_PTR;
  BasePointer: Pointer): IAsyncCall;
var
  Data: TLocalVclCallRec;
...
begin
  case ErrorMode of
    0:
      raise Exception.CreateRes(@RsLeaveMainThreadNestedError);
    1:
      raise Exception.CreateRes(@RsLeaveMainThreadThreadError);
  end;
end;
...
constructor TMultiArgProcCall<TProc, T1, T2>.Create(AProc: TProc;
  const AArg1: T1; const AArg2: T2);
begin
...
{ TMultiArgProcCall<TProc, T1, T2, T3> }
constructor TMultiArgProcCall<TProc, T1, T2, T3>.Create(AProc: TProc;
  const AArg1: T1; const AArg2: T2; const AArg3: T3);
begin
...
constructor TMultiArgProcCall<TProc, T1, T2, T3, T4>.Create(AProc: TProc;
  const AArg1: T1; const AArg2: T2; const AArg3: T3; const AArg4: T4);
begin
...
function TAsyncCalls.TAsyncCallArgMethod<T1, T2, T3, T4>.
...
class function TAsyncCalls.Invoke<T>(Proc: TAsyncCallArgGenericProc<T>;
  const Arg: T): IAsyncCall;
begin
  { Execute the function synchron if no thread pool exists }
...
class function TAsyncCalls.Invoke<T>(Event: TAsyncCallArgGenericMethod<T>;
  const Arg: T): IAsyncCall;
begin
  { Execute the function synchron if no thread pool exists }
  if GetMaxAsyncCallThreads = 0 then
...
class function TAsyncCalls.Invoke<T1, T2>
  (Proc: TAsyncCallArgGenericProc<T1, T2>; const Arg1: T1; const Arg2: T2)
  : IAsyncCall;
begin
  { Execute the function synchron if no thread pool exists }
  if GetMaxAsyncCallThreads = 0 then
...
class function TAsyncCalls.Invoke<T1, T2>
  (Event: TAsyncCallArgGenericMethod<T1, T2>; const Arg1: T1; const Arg2: T2)
  : IAsyncCall;
begin
  { Execute the function synchron if no thread pool exists }
  if GetMaxAsyncCallThreads = 0 then
    ...
    Result := TAsyncCallArgMethod<T1, T2>.Create(Event, Arg1, Arg2)
      .ExecuteAsync;
end;

class function TAsyncCalls.Invoke<T1, T2, T3>
  (Proc: TAsyncCallArgGenericProc<T1, T2, T3>; const Arg1: T1; const Arg2: T2;
  const Arg3: T3): IAsyncCall;
begin
  { Execute the function synchron if no thread pool exists }
  if GetMaxAsyncCallThreads = 0 then
    Result := TSyncCall.Create(Proc(Arg1, Arg2, Arg3))
  else
    Result := TAsyncCallArg<T1, T2, T3>.Create(Proc, Arg1, Arg2, Arg3)
      .ExecuteAsync;
end;

class function TAsyncCalls.Invoke<T1, T2, T3>
  (Event: TAsyncCallArgGenericMethod<T1, T2, T3>; const Arg1: T1;
  const Arg2: T2; const Arg3: T3): IAsyncCall;
begin
  { Execute the function synchron if no thread pool exists }
  if GetMaxAsyncCallThreads = 0 then
    Result := TSyncCall.Create(Event(Arg1, Arg2, Arg3))
  else
    Result := TAsyncCallArgMethod<T1, T2, T3>.Create(Event, Arg1, Arg2, Arg3)
      .ExecuteAsync;
end;

class function TAsyncCalls.Invoke<T1, T2, T3, T4>
  (Proc: TAsyncCallArgGenericProc<T1, T2, T3, T4>; const Arg1: T1;
  const Arg2: T2; const Arg3: T3; const Arg4: T4): IAsyncCall;
begin
  { Execute the function synchron if no thread pool exists }
  if GetMaxAsyncCallThreads = 0 then
    ...
    Result := TAsyncCallArg<T1, T2, T3, T4>.Create(Proc, Arg1, Arg2, Arg3, Arg4)
      .ExecuteAsync;
end;
...
begin
  ...
  if GetMaxAsyncCallThreads = 0 then
    ...
    Result := TAsyncCallArgMethod<T1, T2, T3, T4>.Create(Event, Arg1, Arg2,
      Arg3, Arg4).ExecuteAsync;
end;
...
class procedure TAsyncCalls.MsgExec(AsyncCall: IAsyncCall;
  IdleMsgMethod: TAsyncIdleMsgMethod);
begin
  if GetCurrentThreadId = MainThreadId then
  begin
    ...
    begin
      ...
      IdleMsgMethod;
      while MsgAsyncMultiSync([AsyncCall], False, INFINITE, QS_ALLINPUT or
        QS_ALLPOSTMESSAGE) = 1 do
        IdleMsgMethod;
    end;
  end
